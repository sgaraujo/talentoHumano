/**
 * Consolida el registro manual duplicado de Retención de Junio de UT ITAC.
 * Conserva el vencimiento oficial 2026-07-22 (revisado por contabilidad, "No aplica")
 * y archiva el duplicado importado con fecha incorrecta 2026-07-15 ("No iniciado",
 * nunca tocado por un humano — viene de un import con periodNormalizedFrom: "Mensual-6").
 *
 * Uso:
 *   node scripts/consolidate-ut-itac-retefuente-junio.mjs
 *   node scripts/consolidate-ut-itac-retefuente-junio.mjs --apply
 */
...
const KEEP_ID = 'oriAKHLRXE0VbRGvOeZR';
const REMOVE_ID = 'aIj98hepgol60yOReUU0';
...
async function main() {
  ...
  const expected = value =>
    ...
    value?.period === 'Junio';
  if (!expected(keep) || !expected(remove) || keep?.dueDate !== '2026-07-22' || remove?.dueDate !== '2026-07-15') {
