...
export const CreateQuestionnaireDialog = ({
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            setFormData({ title: '', description: '', targetRole: 'all', active: true, isOnboarding: false, isRequired: false, allowMultipleCompletions: false });
            setQuestions([]);
            setFieldMappings([]);
            setCurrentStep('info');
            onQuestionnaireCreated();
            ...
            toast.error('Error al crear cuestionario', { description: error.message });
        } finally {
            setLoading(false);
        }
    };
    ...
    const stepTitles = {
        info: 'Nuevo Cuestionario',
        questions: 'Agregar Preguntas',
        mappings: 'Mapeo de Campos',
    };

    const stepDescriptions = {
        info: 'Define la información básica del cuestionario',
        questions: 'Agrega y configura las preguntas del cuestionario',
