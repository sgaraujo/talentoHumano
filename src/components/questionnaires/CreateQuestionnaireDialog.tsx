...
import type { Question, QuestionType } from '@/models/types/Questionnaire';
...
export const CreateQuestionnaireDialog = ({
    open,
    onOpenChange,
    ...
    const [formData, setFormData] = useState({
        ...
        active: true,
        isOnboarding: false,
        isRequired: false, // NUEVO
        allowMultipleCompletions: false, // NUEVO
    });
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    <DialogTitle>
                        {currentStep === 'info' ? 'Nuevo Cuestionario' : 'Agregar Preguntas'}
                    </DialogTitle>
                    <DialogDescription>
                        {currentStep === 'info'
                            ? 'Define la información básica del cuestionario'
                            : 'Agrega y configura las preguntas del cuestionario'
                        }
                    </DialogDescription>
                </DialogHeader>
                    ...
                    <div className="space-y-4 py-4">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="space-y-1">
                                <Label htmlFor="isOnboarding">Cuestionario de onboarding</Label>
                                <p className="text-xs text-gray-500">
                                    Las respuestas actualizarán el perfil del usuario
                                </p>
                            </div>
                            <Switch
                                id="isOnboarding"
                                checked={formData.isOnboarding}
                                onCheckedChange={(checked) => setFormData({ ...formData, isOnboarding: checked })}
                            />
                        </div>
                        ...
                        {formData.isOnboarding && (
                            <>
                                <div className="flex items-center justify-between">
                                    <div className="space-y-1">
                                        <Label htmlFor="isRequired">Onboarding obligatorio</Label>
                                        <p className="text-xs text-gray-500">
                                            El usuario debe completarlo para acceder al sistema
                                        </p>
                                    </div>
                                    <Switch
                                        id="isRequired"
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-xs text-gray-500">
                                            El usuario puede responder este cuestionario más de una vez
                                        </p>
                                    </div>
                                    <Switch
                                        id="allowMultiple"
                                        ...
                                        onCheckedChange={(checked) =>
                                            setFormData({ ...formData, allowMultipleCompletions: checked })
                                        }
                                    />
                                </div>
                            </>
