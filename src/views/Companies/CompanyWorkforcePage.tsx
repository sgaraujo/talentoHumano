...
export function CompanyWorkforcePage() {
  ...
  const tabs: Array<[Tab, string]> = [['summary','Resumen'],['stats','Estadísticas'],['people','Personas'],['projects','Proyectos'],...(canSeePayroll ? [['payroll','Nómina'] as [Tab, string]] : []),['quality','Calidad de datos']];
