...
import {
  ...
  TrendingUp, Search, ChevronDown, ChevronUp, Wand2, Download,
...
export const EmailSendStatsPage = () => {
  ...
  const [tab, setTab] = useState<'cuestionarios' | 'fallidos' | 'comunicados'>('cuestionarios');
  ...
  const handleGeneratePdf = async () => {
    ...
    try {
      generateEmailSendReport({ globalStats, byQuestionnaire, byRole, failures, timeline });
            ...
            <div className="divide-y divide-gray-50">
              {comms
                ...
                .map(comm => {
                  ...
                  const activeBar = allCompanies.map(co => {
